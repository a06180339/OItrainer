...
const ORIGINAL_SEASON_WEEKS = 60;
...
const COMPETITION_SCHEDULE = [
  ...
  {week:9, name:"CSP-S1", difficulty:100, maxScore:100, numProblems:1},
  {week:17, name:"CSP-S2", difficulty:145, maxScore:400, numProblems:4},
  // WC: Winter Camp, 通常在冬令营期间，不影响省选晋级，独立比赛
  {week:20, name:"WC", difficulty:260, maxScore:300, numProblems:3, isFriendly: true}, 
...
const COMPETITION_BASE_CUTOFF = {
  ...
  "WC": {
    "强省": 0.60, // WC 为邀请赛性质，分数线相对宽松，主要看排名奖励
    "普通省": 0.50,
    "弱省": 0.40
  },
  "NOIP": {
...
const CONTEST_GAIN_RATIOS = {
  ...
  'WC': { knowledge: 0.8, thinking: 0.8, coding: 0.8 },          // WC级
...
const ONLINE_CONTEST_TYPES = [
  ...
  {name: "Atcoder-ARC-Div2", numProblems: 5, difficulty: 200, displayName: "Atcoder ARC Div.2"},
  {name: "Atcoder-ARC-Div1", numProblems: 5, difficulty: 300, displayName: "Atcoder ARC Div.1"},
  {name: "Atcoder-AGC", numProblems: 6, difficulty: 450, displayName: "Atcoder AGC"},
  ...
  {name: "Codeforces-Div1", numProblems: 7, difficulty: 450, displayName: "Codeforces Div.1"},
  ...
  {name: "USACO-Platinum", numProblems: 3, difficulty: 460, displayName: "USACO Platinum"},
];
