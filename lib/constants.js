...
const ALPHA1 = 28.0;
/* 省份基础 */
const STRONG_PROVINCE_BUDGET = 150000;
...
const COMPETITION_SCHEDULE = [
  ...
  {week:9, name:"CSP-S1", difficulty:20, maxScore:100, numProblems:1},
  {week:17, name:"CSP-S2", difficulty:170, maxScore:400, numProblems:4},
  {week:20, name:"WC", difficulty:500, maxScore:300, numProblems:3},
  {week:30, name:"NOIP", difficulty:220, maxScore:400, numProblems:4},
  {week:40, name:"省选", difficulty:475, maxScore:600, numProblems:6},
  {week:50, name:"APIO", difficulty:500, maxScore:300, numProblems:3},
  {week:60, name:"NOI", difficulty:530, maxScore:700, numProblems:7},
  ...
  {week:74, name:"CTT-day1-2", difficulty:570, maxScore:600, numProblems:6, nationalTeam:true},
  {week:75, name:"CTT-day3-4", difficulty:650, maxScore:600, numProblems:6, nationalTeam:true},
  {week:76, name:"CTS", difficulty:680, maxScore:800, numProblems:8, nationalTeam:true},
  {week:80, name:"IOI", difficulty:700, maxScore:600, numProblems:6, nationalTeam:true, subtasksPerProblem:15}
];
...
//初始能力
const KNOWLEDGE_ABLILTY_START = 40;
...
const OUTFIT_KNOWLEDGE_BASE_BASIC = 6;
const OUTFIT_KNOWLEDGE_BASE_INTERMEDIATE = 8;
const OUTFIT_KNOWLEDGE_BASE_ADVANCED = 10;
const OUTFIT_ABILITY_BASE_BASIC = 6.0;
const OUTFIT_ABILITY_BASE_INTERMEDIATE = 10.0;
const OUTFIT_ABILITY_BASE_ADVANCED = 15.0;
