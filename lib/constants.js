...
const OUTFIT_KNOWLEDGE_BASE_ADVANCED = 15;
const OUTFIT_ABILITY_BASE_BASIC = 12.0;
const OUTFIT_ABILITY_BASE_INTERMEDIATE = 15.0;
const OUTFIT_ABILITY_BASE_ADVANCED = 20.0;
const OUTFIT_PRESSURE_BASIC = 15;
const OUTFIT_PRESSURE_INTERMEDIATE = 20;
const OUTFIT_PRESSURE_ADVANCED = 30;
/* 声誉对外出集训/商业/媒体的影响系数 */
