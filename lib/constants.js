...
/* 比赛日程 */
const WEEKLY_SUBSIDY_BASE = 3000;
const SUBSIDY_REP_BONUS = 100;
...
const COMPETITION_SCHEDULE = [
  ...
  {week:74, name:"CTT-day1-2", difficulty:560, maxScore:600, numProblems:6, nationalTeam:true},
  {week:75, name:"CTT-day3-4", difficulty:570, maxScore:600, numProblems:6, nationalTeam:true},
  {week:76, name:"CTS", difficulty:700, maxScore:800, numProblems:8, nationalTeam:true},
  {week:80, name:"IOI", difficulty:780, maxScore:600, numProblems:6, nationalTeam:true, subtasksPerProblem:15}
];
...
const COMPETITION_DIFFICULTY_FACTORS = {
  ...
  "NOI": [0.5, 0.6, 1.3, 1.3, 0.8, 1.5, 1.7],
  // 国家集训队比赛难度系数
...
const WC_ENTRY_THRESHOLD = 180;   // CSP-S2 达到 180 分可参加 WC
const APIO_ENTRY_THRESHOLD = 250; // CSP-S2 达到 250 分可参加 APIO
