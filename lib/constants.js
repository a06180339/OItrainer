...
const ORIGINAL_SEASON_WEEKS = 80;
...
const ABILITY_DECAY_THRESHOLD = 500;
/* 压力/恢复 */
const RECOVERY_RATE = 7.0;
const FATIGUE_FROM_PRESSURE = 180.0;
const ALPHA1 = 28.0;
/* 省份基础 */
const STRONG_PROVINCE_BUDGET = 800000;
const NORMAL_PROVINCE_BUDGET = 500000;
const WEAK_PROVINCE_BUDGET = 40000;
const STRONG_PROVINCE_TRAINING_QUALITY = 1.5;
...
const COMPETITION_SCHEDULE = [
  ...
  {week:10, name:"CSP-S1", difficulty:65, maxScore:100, numProblems:1},
  {week:18, name:"CSP-S2", difficulty:165, maxScore:400, numProblems:4},
  {week:26, name:"NOIP", difficulty:225, maxScore:400, numProblems:4},
  {week:42, name:"省选", difficulty:400, maxScore:600, numProblems:6},
  {week:54, name:"NOI", difficulty:500, maxScore:700, numProblems:7},
  ...
  {week:56, name:"CTT-day1-2", difficulty:550, maxScore:600, numProblems:6, nationalTeam:true},
  {week:57, name:"CTT-day3-4", difficulty:550, maxScore:600, numProblems:6, nationalTeam:true},
  {week:58, name:"CTS", difficulty:600, maxScore:800, numProblems:8, nationalTeam:true},
  {week:59, name:"IOI", difficulty:700, maxScore:600, numProblems:6, nationalTeam:true, subtasksPerProblem:15}
];
...
const COMPETITION_DIFFICULTY_FACTORS = {
  ...
  "CSP-S2": [0.3, 1.2, 1.3, 2.0],
  "NOIP": [0.7, 0.8, 1.5, 1.5],
...
const STRONG_PROVINCE_MAX_ABILITY = 100.0;
...
//初始能力
const KNOWLEDGE_ABLILTY_START = 20;
...
const FACILITY_UPGRADE_COSTS = {
  computer: {base:30000,grow:1},
  library: {base:15000,grow:1},
  ac: {base:8000,grow:1},
  dorm: {base:8000,grow:1},
  canteen: {base:8000,grow:1}
};
const MAX_COMPUTER_LEVEL = 6;
const MAX_LIBRARY_LEVEL = 6;
const MAX_OTHER_FACILITY_LEVEL = 4;
...
const TRAINING_PRESSURE_MULTIPLIER_MEDIUM = 1.25;
const TRAINING_PRESSURE_MULTIPLIER_HEAVY = 1.5;
...
const GET_TALENT_Probability = 0.5;
...
const CONTEST_MAX_TOTAL_KNOWLEDGE_GAIN = 13;     // 知识点总增幅上限（低于中等训练的15）
const CONTEST_MAX_TOTAL_THINKING_GAIN = 68;    // 思维总增幅上限（低于基础集训的12）
const CONTEST_MAX_TOTAL_CODING_GAIN = 8;      // 代码总增幅上限（低于基础集训的12）
...
const ONLINE_CONTEST_TYPES = [
  ...
  {name: "Atcoder-ARC-Div1", numProblems: 5, difficulty: 170, displayName: "Atcoder ARC Div.1"},
  {name: "Atcoder-ARC-Div2", numProblems: 5, difficulty: 260, displayName: "Atcoder ARC Div.2"},
  {name: "Atcoder-AGC", numProblems: 6, difficulty: 400, displayName: "Atcoder AGC"},

  {name: "Codeforces-Div4", numProblems: 7, difficulty: 80, displayName: "Codeforces Div.4"},
  {name: "Codeforces-Div3", numProblems: 5, difficulty: 120, displayName: "Codeforces Div.3"},
  {name: "Codeforces-Div2", numProblems: 7, difficulty: 230, displayName: "Codeforces Div.2"},
  {name: "Codeforces-Div1", numProblems: 7, difficulty: 370, displayName: "Codeforces Div.1"},

  {name: "洛谷月赛", numProblems: 4, difficulty: 240, displayName: "洛谷月赛"},
  {name: "Ucup", numProblems: 4, difficulty: 370, displayName: "Ucup"},

  {name: "USACO-Bronze",   numProblems: 3, difficulty: 120, displayName: "USACO Bronze"},
  {name: "USACO-Silver",   numProblems: 3, difficulty: 200, displayName: "USACO Silver"},
  {name: "USACO-Gold",     numProblems: 3, difficulty: 350, displayName: "USACO Gold"},
  {name: "USACO-Platinum", numProblems: 3, difficulty: 450, displayName: "USACO Platinum"},

  {name: "MX-Weekly", numProblems: 4, difficulty: 300, displayName: "梦熊周赛"}
];
...
/* =========== 失误系统 =========== */
// 失误概率基础参数
const MISTAKE_BASE_PROBABILITY = 0.3;  // 代码能力为0时的基础失误概率
...
const PROVINCES = {
  // 强省（排名越靠前越强）
  1:{name:"北京",type:"强省",isNorth:true,baseBudget:400000,trainingQuality:STRONG_PROVINCE_TRAINING_QUALITY},
  2:{name:"上海",type:"强省",isNorth:false,baseBudget:390625,trainingQuality:STRONG_PROVINCE_TRAINING_QUALITY},
  3:{name:"浙江",type:"强省",isNorth:false,baseBudget:381250,trainingQuality:STRONG_PROVINCE_TRAINING_QUALITY},
  4:{name:"江苏",type:"强省",isNorth:false,baseBudget:371875,trainingQuality:STRONG_PROVINCE_TRAINING_QUALITY},
  5:{name:"广东",type:"强省",isNorth:false,baseBudget:362500,trainingQuality:STRONG_PROVINCE_TRAINING_QUALITY},
  6:{name:"山东",type:"强省",isNorth:false,baseBudget:353125,trainingQuality:STRONG_PROVINCE_TRAINING_QUALITY},
  7:{name:"重庆",type:"强省",isNorth:false,baseBudget:343750,trainingQuality:STRONG_PROVINCE_TRAINING_QUALITY},
  8:{name:"四川",type:"强省",isNorth:false,baseBudget:334375,trainingQuality:STRONG_PROVINCE_TRAINING_QUALITY},
  9:{name:"福建",type:"强省",isNorth:false,baseBudget:325000,trainingQuality:STRONG_PROVINCE_TRAINING_QUALITY},
 10:{name:"湖南",type:"强省",isNorth:false,baseBudget:315625,trainingQuality:STRONG_PROVINCE_TRAINING_QUALITY},

  // 普通省（按实力排序）
 11:{name:"河北",type:"普通省",isNorth:true,baseBudget:306250,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 12:{name:"天津",type:"普通省",isNorth:true,baseBudget:296875,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 13:{name:"陕西",type:"普通省",isNorth:true,baseBudget:287500,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 14:{name:"辽宁",type:"普通省",isNorth:true,baseBudget:278125,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 15:{name:"黑龙江",type:"普通省",isNorth:true,baseBudget:268750,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 16:{name:"吉林",type:"普通省",isNorth:true,baseBudget:259375,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 17:{name:"河南",type:"普通省",isNorth:false,baseBudget:250000,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 18:{name:"湖北",type:"普通省",isNorth:false,baseBudget:240625,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 19:{name:"安徽",type:"普通省",isNorth:false,baseBudget:231250,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 20:{name:"江西",type:"普通省",isNorth:false,baseBudget:221875,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 21:{name:"广西",type:"普通省",isNorth:false,baseBudget:212500,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 22:{name:"山西",type:"普通省",isNorth:true,baseBudget:203125,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 23:{name:"香港",type:"普通省",isNorth:false,baseBudget:193750,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},
 24:{name:"贵州",type:"普通省",isNorth:false,baseBudget:184375,trainingQuality:NORMAL_PROVINCE_TRAINING_QUALITY},

  // 弱省（按实力从弱到最弱）
 25:{name:"新疆",type:"弱省",isNorth:true,baseBudget:175000,trainingQuality:WEAK_PROVINCE_TRAINING_QUALITY},
 26:{name:"内蒙古",type:"弱省",isNorth:true,baseBudget:165625,trainingQuality:WEAK_PROVINCE_TRAINING_QUALITY},
 27:{name:"甘肃",type:"弱省",isNorth:true,baseBudget:156250,trainingQuality:WEAK_PROVINCE_TRAINING_QUALITY},
 28:{name:"青海",type:"弱省",isNorth:true,baseBudget:146875,trainingQuality:WEAK_PROVINCE_TRAINING_QUALITY},
 29:{name:"宁夏",type:"弱省",isNorth:true,baseBudget:137500,trainingQuality:WEAK_PROVINCE_TRAINING_QUALITY},
 30:{name:"海南",type:"弱省",isNorth:false,baseBudget:128125,trainingQuality:WEAK_PROVINCE_TRAINING_QUALITY},
 31:{name:"云南",type:"弱省",isNorth:false,baseBudget:118750,trainingQuality:WEAK_PROVINCE_TRAINING_QUALITY},
 32:{name:"澳门",type:"弱省",isNorth:false,baseBudget:109375,trainingQuality:WEAK_PROVINCE_TRAINING_QUALITY},
 33:{name:"西藏",type:"弱省",isNorth:true,baseBudget:100000,trainingQuality:WEAK_PROVINCE_TRAINING_QUALITY}
};
