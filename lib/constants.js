...
const ALPHA1 = 28.0;
/* 省份基础 */
const STRONG_PROVINCE_BUDGET = 1000000;
const NORMAL_PROVINCE_BUDGET = 5000000;
const WEAK_PROVINCE_BUDGET = 40000;
const STRONG_PROVINCE_TRAINING_QUALITY = 2;
...
const ONLINE_CONTEST_TYPES = [
  ...
  {name: "Atcoder-ARC-Div1", numProblems: 5, difficulty: 170, displayName: "Atcoder ARC Div1"},
  {name: "Atcoder-ARC-Div2", numProblems: 5, difficulty: 260, displayName: "Atcoder ARC Div2"},
