...
const TASK_POOL = [
  ...
  { name: '[NOI1145] 题目名我实在编不下去了', difficulty: 174, boosts: [{ type: '字符串', amount: 40 }, { type: '图论', amount: 17 }, { type: '数据结构', amount: 16 }] },
  ...
  { name: '[HEOI2016/TJOI2016] 字符串', difficulty: 180, boosts: [{ type: '字符串', amount: 45 }, { type: '数据结构', amount: 45 }] },
  { name: '[TJOI2015] 弦论', difficulty: 120, boosts: [{ type: '字符串', amount: 35 }, { type: '数据结构', amount: 10 }]},
  { name: '[CERC2014] Virus synthesis, difficulty: 125, boosts: [{ type: '字符串', amount: 35 }] },
  { name: '[联合省选2026] 摩卡串', difficulty: 200, boosts: [{ type: '字符串', amount: 50}, { type: '数据结构', amount: 40 }, { type: '动态规划', amount: 40 } ]},
  { name: '[联合省选2026] 星图', difficulty: 200, boosts: [{ type: '数学', amount: 50 }] },
];
